class User < ApplicationRecord
    ...
    has_many :friender_friends, foreign_key: 'sent_to_id', class_name: 'Friend', dependent: :destroy
    ...
    has_many :sent_reqs, -> { merge(Friend.sent_reqs) }, through: :senders, source: :sent_to, dependent: :destroy
    
    has_many :receivers, foreign_key: 'sent_to_id', class_name: 'Friend'
    has_many :received_reqs, -> { merge(Friend.received_reqs) }, through: :receivers, source: :sent_by, dependent: :destroy
